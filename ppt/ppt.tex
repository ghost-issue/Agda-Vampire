...
\end{Verbatim}
    \vfill
    Then \texttt{trans t1 t2}, we got the answer.
\end{frame}
...
\begin{frame}{A classical proof to intuitionistic proof}
    ...
    \end{itemize}
    \vfill
    {\footnotesize $\Gamma$ is a set of definite clauses, $G$ is Goal Atom. \\}
...
\begin{frame}{Lemma}
    \begin{itemize}
        ...
        \item Lemma 2: Vampire Core Calculus (Horn version) is intuitionistically valid.
        \item Lemma 3: If we have $\bot$ derived from Vampire Core Calculus (Horn version), then ???
    \end{itemize}
\end{frame}
...
\begin{frame}{Vampire Core Calculus (General and Horn Clause)}
    ...
    \begin{columns}[T]
      \begin{column}{0.46\textwidth}
        \centering\scriptsize\textbf{General}
        \begin{mathpar}
      ...
      \begin{column}{0.54\textwidth}
        \centering\scriptsize\textbf{Horn Clause}
        \begin{mathpar}
...
\begin{frame}{Vampire Core Calculus (Clause and Implication)}
    ...
    \begin{columns}[T]
      \begin{column}{0.50\textwidth}
        \centering\scriptsize\textbf{Clause}
        \begin{mathpar}
          \inferrule*[right=\textsc{Res.}]{\neg P \lor A \quad \neg A' \lor \neg Q \lor \boxed{B}}{\sigma(\neg P \lor \neg Q \lor \boxed{B})}
        \end{mathpar}
        \begin{mathpar}
      ...
      \end{column}
      \begin{column}{0.50\textwidth}
        \centering\scriptsize\textbf{Implication}
        \begin{mathpar}
...
\begin{frame}{Example 2}
    ...
    \end{mathpar}
    {\footnotesize replace $\boxed{\bot}$ by a = b}
\end{frame}

\section{Thesis Proposal}
\begin{frame}{Thesis Proposal}
    \begin{itemize}
        \item Formalize superposition calculus (5 Implication rules) by deep embedding.
...
\begin{frame}{References}
    ...
    \begin{itemize}
        ...
        \item Laura Kovács and Andrei Voronkov.  "Vampire Guide Lectures."
